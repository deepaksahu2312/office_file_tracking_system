...
class Application(models.Model):
    ...
    attached_pdf = models.FileField(upload_to='documents/',null=True, blank=True, default=None)

    # attached_pdf = models.FileField(upload_to=get_pdf_path,validators=[FileExtensionValidator(["pdf"])],
